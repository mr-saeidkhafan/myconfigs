...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "z", function() awful.util.spawn("xzoom") end,
              {description = "zoom", group = "hotkeys"}),
    ...
    awful.key({ }, "Print", function() awful.spawn.with_shell("scrot -q 80 /home/core/Pictures/screenshot/shot.png & play -n synth 0.05 sine 880 vol 0.5A") end,
              {description = "take a screenshot", group = "hotkeys"}),

    awful.key({ "Shift" }, "Print", function() awful.spawn.with_shell(screenshot_cmd) end,
              {description = "take a crop screenshot", group = "hotkeys"}),
    ...
    awful.key({ modkey }, "r", function ()
            os.execute(string.format("dmenu_run -l 12 -i -nb '%s' -nf '%s' -sb '%s' -sf '%s'",
